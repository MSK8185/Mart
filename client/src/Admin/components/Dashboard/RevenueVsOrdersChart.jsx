    ...
    const fetchData = async () => {
      try {
        ...
        const newData = [
          {
            name: "Today",
            Revenue: revenueData.averageRevenue,
            Order: ordersData.totalOrders,
          },
          {
            name: "Yesterday",
            Revenue: revenueData.averageRevenue * 0.9,
            Order: ordersData.totalOrders - 5,
          },
          {
            name: "Last Week",
            Revenue: revenueData.averageRevenue * 0.8,
            Order: ordersData.totalOrders - 10,
          },
        ];
